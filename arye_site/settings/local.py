...
# Default API token for local development (override via WHITE_CATALOG_API_TOKEN env var)
WHITE_CATALOG_API_TOKEN = WHITE_CATALOG_API_TOKEN or 'dev-local-token'
